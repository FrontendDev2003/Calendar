...
let HolidayService = (() => {
    ...
    let _classThis;
    var HolidayService = _classThis = class {
        constructor() {
        ...
        listHolidays() {
            return __awaiter(this, void 0, void 0, function* () {
                const res = yield this.db.query('SELECT date FROM holidays');
                return res.rows;
            });
        }
        addHoliday(date) {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.db.query('INSERT INTO holidays (date) VALUES ($1)', [date]);
                return { message: 'Holiday added' };
            });
        }
        deleteHoliday(date) {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.db.query('DELETE FROM holidays WHERE date = $1', [date]);
